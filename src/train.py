...
def main(args):
    ...
    # Add this line to calculate the total number of trainable parameters
    ...
    # vae = AutoencoderKL.from_pretrained("vqvae_560.pt").to(device)

    # vae_model_path = 'vqvae_560.pt'
    # vae = AutoencoderKL()
    ...
    # vae = load_model('vqvae', 'vqvae_560.pt', device)
    ...
    for epoch in range(args.epochs):
        ...
        for x, y in loader:
            ...
            # # Add print statements to inspect shapes of tensors
            # print("Input tensor shape (x):", x.shape)
            # print("Target tensor shape (y):", y.shape)

            with torch.no_grad():
                # Map input images to latent space + normalize latents:
                x = vae.encode(x).latent_dist.sample().mul_(0.18215)
            # print("Transformed input tensor shape (x):", x.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-classes", type=int, default=6217)
